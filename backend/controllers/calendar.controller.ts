...
export const addCalendar = asyncHandler(
  async (req: CalendarRequest, res: Response, next: NextFunction) => {
...
export const getDeletedCalendars = asyncHandler(
  async (req: CalendarRequest, res: Response, next: NextFunction) => {
    const { userHash } = req.params;
...
export const updateWriteIntoCalendar = asyncHandler(
  async (req: CalendarRequest, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      try {
        const googleWatchInfo = await updateGoogleWatchHook(
          ownerEmail,
          updatedCalendar.googleWriteInto
        );
...
export const getFullCalendar = asyncHandler(
  async (req: CalendarRequest, res: Response, next: NextFunction) => {
    const { hash } = req.params;
