...
//When changing this file , make sure to change the same in the backend/frontend

const algorithm = 'aes-256-cbc'; // Encryption algorithm
const originalKey = process.env.NEXT_PUBLIC_ENCRYPTION_KEY as string; // Encryption key
